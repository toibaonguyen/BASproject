...
const UserInfoScreen = () => {
  ...
  const uploadImage = async () => {
    ...
    setUploading(false);
    Alert.alert('Avatar changed successfully!', 'Your avatar has been changed');
    setImage({uri: ''});
    setisVisible(false);
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={{flex: 1, alignItems: 'center'}}>
        <Modal isVisible={isVisible} animationOutTiming={500}>
          {image.uri === '' ? (
            <View
              ...
              <Button onPress={openGallery}>Choose from library</Button>
              <Button
                onPress={() => {
                  setisVisible(false);
                }}>
        ...
        <Modal isVisible={isVisible1} animationOutTiming={500}>
          <View
            ...
            <CustomInput
              ...
              value={username0}
              setvalue={setusername0}
            />
            <CustomInput
              placeholder="Full name"
              value={fullname0}
              setvalue={setfullname0}
            />
            <CustomInput
        ...
        <View
          ...
          <Text style={{fontWeight: 'bold', fontSize: 15, bottom: 10}}>
            Details:
          </Text>
        ...
        <View style={{marginTop: 15, width: width - 40}}>
          ...
          />
          <CustomBtnWithIcon
            text="Want to make purchase for something? Post it"
            iconname="form"
            bgColor="white"
            fgColor="black"
            type="TERTIARY"
