  ...
  return (
    <View style={{padding:10}}>
      ...
      <Stars
        ...
        disabled={true}
        emptyStar={
          <Icon name={'star-o'} color="#e47911" style={styles.star} size={25} />
        }
        halfStar={
          <Icon
            name={'star-half-full'}
      ...
      <View style={{borderBottomWidth:1,marginTop:5,width:"50%",alignSelf:"center"}}></View>
    </View>
  );
};
...
const ProductScreen = ({route, navigation}) => {
  ...
  return (
    ...
    <ScrollView style={{backgroundColor: 'white'}}>
      ...
      <View>
      <Text style={{marginLeft:10,fontSize:25,color:"black",textDecorationLine:"underline"}}>Feedback:</Text>
