...
const SignUpScreen = () => {
  ...
  const onRegisterPressed=async()=>{
    ...
    if(username==""||password==""||email==""||passwordrepeat==""||phone==""||name==""){
  ...
  return (
    ...
    <View style={styles.root}>
      ...
      <Text style={styles.link} onPress={onTermsAndPPPressed}>Terms of use and Privacy Policy</Text>
      </Text> 
      <CustomButton text="Sign in with Facebook" onPress={onSignInFacebook} bgColor="#E7EAF4" fgColor="#4765A9" />
      <CustomButton text="Sign in with Google" onPress={onSignInGoogle} bgColor="#FAE9EA" fgColor="#DD4D44" />
      <CustomButton text="Have account already? Sign in" onPress={onSignInPressed} type="TERTIARY"/>
